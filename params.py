...
def get_params():
  ...
  # Parameters
  params['dataset']             = 'oxford'  # oxford | paris
  ...
  params['fast_rcnn_path']      = '../../dongdk/faster-rcnn-branches/faster-rcnn-v5/'
  params['net']                 = '../../dongdk/faster-rcnn-branches/faster-rcnn-v5/data/faster_rcnn_models/VGG16_faster_rcnn_final.caffemodel'
  params['net_proto']           = '../../dongdk/faster-rcnn-branches/faster-rcnn-v5/models/pascal_voc/VGG16/faster_rcnn_alt_opt/faster_rcnn_test.pt'
  ...
  if params['dataset'] is 'oxford':
    ...
    params['query_names']       = ["all_souls", "ashmolean", "balliol", "bodleian", 
    ...
    params['query_names']       = ["defense", "eiffel", "invalides", "louvre", "moulinrouge", 
  ...
  list_of_dirs = ['data/imagelists', 'data/rankings/', 'data/features', 'data/rankings', 
                  'data/rankings/oxford', 'data/rankings/paris', 'data/reranking', 
                  'data/pca','data/figures']
